...
import kiddokompas from '../../../assets/images/projects/thumbnails/kiddokompas.png';
...
function Projects() {
    return (
        <Container id="projects" className="my-5 my-md-4 py-md-5">
            <motion.h2
            ...
            <Row className='align-items-center mb-md-5 py-5'>
                <Col lg={7} className="pe-lg-5">
                    <motion.div
                        ...
                        transition={{ duration: 0.6 }}
                    >
                        <img src={kiddokompas} alt="KiddoKompas" className="img-fluid rounded-4"/>
                    </motion.div>
                </Col>
                ...
                <Col lg={5} className="ps-lg-5">
                    ...
                    >
                        <h3>KiddoKompas</h3>
                        <p className='mb-5 text-muted'>Kids’ activities platform</p>
                        <p className='mb-4'>Designed and developed the platform from concept to implementation, with a focus on helping parents quickly find suitable programs by age, location, and interests.</p>
                        <a href='https://kiddokompas.rs/en' className='btn btn-primary' target='_blank' rel="noreferrer">Visit website</a>
                    </motion.div>
                </Col>
            </Row>
            ...
            <Row className='align-items-center mb-md-5 py-5'>
                ...
                <Col lg={5} className="pe-lg-5 order-lg-1 order-2">
                    ...
                    >
                        ...
                        <a href='https://cpvlab.pro/' className='btn btn-primary' target='_blank' rel="noreferrer">Visit website</a>
                    </motion.div>
                </Col>
            </Row>
            ...
            <Row className='align-items-center mb-md-5 py-5'>
                ...
                <Col lg={5} className="ps-lg-5">
                    ...
                    >
                        ...
                        <a href='https://cpvone.com/' className='btn btn-primary' target='_blank' rel="noreferrer">Visit website</a>
                    </motion.div>
                </Col>
            </Row>
            ...
            <Row className='align-items-center mb-md-5 py-5'>
                ...
                <Col lg={5} className="pe-lg-5 order-lg-1 order-2">
                    ...
                    >
                        ...
                        <a href='https://www.ruoomsoftware.com/' className='btn btn-primary' target='_blank' rel="noreferrer">Visit website</a>
                    </motion.div>
                </Col>
            </Row>
            ...
            <Row className='align-items-center mb-md-5 py-5'>
                ...
                <Col lg={5} className="ps-lg-5">
                    ...
                    >
                        ...
                        <a href='https://www.dogleg.cz/' className='btn btn-primary' target='_blank' rel="noreferrer">Visit website</a>
                    </motion.div>
                </Col>
            </Row>
            ...
            <Row className='align-items-center mb-md-5 py-5'>
                ...
                <Col lg={5} className="pe-lg-5 order-lg-1 order-2">
                    ...
                    >
                        ...
                        <a href='https://shootingpeople.org/' className='btn btn-primary' target='_blank' rel="noreferrer">Visit website</a>
                    </motion.div>
                </Col>
            </Row>
    </Container>
